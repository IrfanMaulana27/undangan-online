...
var countDownDate = new Date("Jun 22, 2024 09:00:00").getTime();
...
function no1() {
  ...
  toastr["success"]("No Rek BCA Berhasil Disalin", "Success");
}
function no2() {
  ...
  document.execCommand("copy");
  document.body.removeChild(textarea);
  toastr["success"]("No Rek DKI Berhasil Disalin", "Success");
}
